    ...
    <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-slate-100">
      ...
      <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-8">
        ...
        <button 
          ...
          className="w-full py-5 bg-slate-900 text-white rounded-[1.5rem] font-bold text-xs uppercase tracking-[0.3em] shadow-xl shadow-slate-200 hover:bg-black transition-all flex items-center justify-center gap-3 disabled:opacity-50"
        >
          {isSubmitting ? (
