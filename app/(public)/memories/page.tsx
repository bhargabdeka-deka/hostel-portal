      ...
      <section className="max-w-7xl mx-auto px-6 space-y-24">
        ...
        <div className="max-w-7xl mx-auto w-full space-y-12">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-stretch">
            <div className="lg:col-span-2 bg-slate-950 rounded-[2.5rem] p-12 text-slate-50 shadow-2xl shadow-slate-200/50 relative overflow-hidden group flex flex-col justify-center border border-slate-800">
              <div className="absolute top-0 right-0 p-12 opacity-[0.03] rotate-12 group-hover:rotate-45 transition-transform duration-700">
              ...
              <div className="relative z-10 space-y-8">
                ...
                <div className="pt-6 flex items-center gap-6">
                  ...
                  <span className="text-xs font-black uppercase tracking-[0.3em] text-amber-500/80">Contribute to the legacy</span>
                </div>
              </div>
            </div>
