      ...
      <section className="max-w-7xl mx-auto px-6 space-y-24">
        ...
        <div className="max-w-7xl mx-auto w-full space-y-12">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-stretch">
            <div className="lg:col-span-2 bg-indigo-600 rounded-[2.5rem] p-12 text-white shadow-2xl shadow-indigo-100 relative overflow-hidden group flex flex-col justify-center">
              ...
              <div className="relative z-10 space-y-8">
                <h3 className="text-4xl md:text-5xl font-bold tracking-tighter leading-tight">Your story is part of ORION's history.</h3>
                ...
                <div className="pt-6 flex items-center gap-6">
                  <div className="h-px w-16 bg-indigo-400" />
                  <span className="text-xs font-black uppercase tracking-[0.3em] text-indigo-300">Contribute to the legacy</span>
                </div>
              </div>
            </div>
