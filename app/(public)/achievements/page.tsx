  ...
  return (
    <main className="bg-background min-h-screen selection:bg-blue-500/20 overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
          {achievements && achievements.length > 0 ? (
            achievements.map((achievement) => (
              <div key={achievement.id} className="group bg-white/5 border border-white/5 rounded-[2rem] md:rounded-[2.5rem] overflow-hidden hover:bg-white/10 transition-all duration-700 shadow-2xl">
            ...
            <div className="col-span-full py-24 md:py-40 text-center bg-white/5 rounded-[2rem] md:rounded-[3rem] border border-white/5">
      ...
      <section className="max-w-7xl mx-auto px-6 pb-32">
        <div className="bg-[#020617] border border-white/5 rounded-[3rem] md:rounded-[4rem] overflow-hidden relative min-h-[400px] md:min-h-[500px] flex items-center shadow-2xl">
