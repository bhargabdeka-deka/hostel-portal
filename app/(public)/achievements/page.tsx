    ...
    <main className="bg-transparent min-h-screen selection:bg-blue-500/20 overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto px-6 pt-12 md:pt-24 pb-8 md:pb-16 space-y-4 md:space-y-6">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[7px] md:text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Honoring Excellence</span>
        </div>
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-black text-slate-900 tracking-tighter uppercase leading-[1.1] font-heading">
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <h2 className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] mb-8 md:mb-12 flex items-center gap-4 font-heading">
            ...
            achievements.map((achievement) => (
              <div key={achievement.id} className="group bg-white border border-slate-100 rounded-2xl md:rounded-[2.5rem] overflow-hidden hover:border-blue-100 transition-all duration-300 shadow-lg">
                ...
                <div className="p-3 md:p-4 pt-0 pb-6 md:pb-8">
                  <h3 className="text-[10px] md:text-base font-black text-slate-900 tracking-tight group-hover:text-blue-600 transition-colors leading-tight uppercase line-clamp-2">
                    {achievement.title}
                  </h3>
                </div>
              </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-32">
        <div className="bg-slate-50 border border-slate-200 rounded-[3rem] md:rounded-[4rem] overflow-hidden relative min-h-[400px] md:min-h-[500px] flex items-center shadow-xl">
          ...
          <div className="relative z-20 p-8 md:p-12 lg:p-24 max-w-2xl space-y-6 md:space-y-8">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-slate-900 tracking-tighter leading-tight uppercase font-heading">
            ...
            <div className="flex gap-8 md:gap-16 pt-4">
              <div>
                <div className="text-3xl md:text-5xl font-black text-slate-900 mb-1">15+</div>
                <div className="text-[8px] md:text-[10px] font-black text-blue-600 uppercase tracking-widest">Major Titles</div>
              </div>
              <div>
                <div className="text-3xl md:text-5xl font-black text-slate-900 mb-1">08+</div>
                <div className="text-[8px] md:text-[10px] font-black text-blue-600 uppercase tracking-widest">Sports Categories</div>
              </div>
            </div>
          </div>
