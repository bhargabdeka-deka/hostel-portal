  ...
  return (
    <div className="max-w-5xl mx-auto pt-32 pb-16 md:pt-40 md:pb-24 px-6 overflow-x-hidden">
      <div className="mb-12 md:mb-16">
        <Link href="/" className="inline-flex items-center gap-2 text-slate-400 hover:text-blue-600 font-bold text-[10px] uppercase tracking-widest mb-8 transition-colors">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight uppercase leading-none">Official Board</h1>
        </div>
      ...
      <div className="space-y-6 md:space-y-8">
        {notices && notices.length > 0 ? (
            ...
            <div key={notice.id} className="p-8 md:p-10 bg-white border border-slate-100 rounded-[2.5rem] shadow-sm group hover:border-blue-200 transition-all duration-500">
              <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-6 md:mb-8 pb-6 md:pb-8 border-b border-slate-50">
                <div className="flex items-center gap-3 overflow-hidden">
                  ...
                  <h2 className="text-xl md:text-2xl font-bold text-slate-900 group-hover:text-blue-600 transition-colors uppercase tracking-tight truncate">
                    {notice.title}
                  </h2>
                </div>
                <div className="flex items-center gap-2 text-[8px] md:text-[10px] font-bold text-slate-400 uppercase tracking-widest bg-slate-50 px-4 py-2 rounded-full w-fit">
          ...
          <div className="py-24 md:py-32 text-center bg-slate-50 rounded-[3rem] border-2 border-dashed border-slate-200">
            ...
            <h3 className="text-lg md:text-xl font-bold text-slate-400 uppercase tracking-widest">No Active Notices</h3>
