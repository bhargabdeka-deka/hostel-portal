    ...
    <main className="bg-transparent min-h-screen selection:bg-amber-500/20 overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto px-8 pt-32 pb-12 md:pt-40 md:pb-16 lg:pt-48 lg:pb-24 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        <div className="flex-1 space-y-10 text-center lg:text-left">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-[#0F172A] tracking-[-0.06em] leading-[0.95] font-jakarta">
            A Legacy of <br/><span className="text-[#C8A96B] italic">Excellence.</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-8 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-12">
          {[
            { tag: 'Legacy', icon: <Calendar className="w-6 h-6" />, value: "42+", label: "Years of History", color: 'text-[#0F172A]', bgColor: 'bg-white', borderColor: 'border-slate-100/80' },
            { tag: 'Community', icon: <Users className="w-6 h-6" />, value: "800+", label: "Glorious Alumni", color: 'text-[#0F172A]', bgColor: 'bg-white', borderColor: 'border-slate-100/80' },
            { tag: 'Identity', icon: <GraduationCap className="w-6 h-6" />, value: "JEC", label: "Hostel 7 Heritage", color: 'text-[#C8A96B]', bgColor: 'bg-white', borderColor: 'border-slate-100/80' },
          ].map((stat, i) => (
      ...
      <section className="max-w-7xl mx-auto px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-12">
        <div className="bg-white border border-slate-100/80 rounded-[4rem] p-10 md:p-16 shadow-[0_40px_100px_-30px_rgba(15,23,42,0.06)] group relative overflow-hidden">
          ...
          <div className="flex items-center gap-6 mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-[#0F172A] tracking-tighter font-jakarta">Our History</h2>
          </div>
          <div className="space-y-8 text-slate-500 leading-relaxed font-medium text-lg font-sans relative z-10 opacity-90">
            ...
            <p>
              Our collective reflections find a voice in <span className="text-[#0F172A] font-bold italic">"Arunabh"</span>, the hostel wall magazine. For us, it's more than just a name—it's a race. We are <span className="text-[#0F172A] font-bold uppercase tracking-[0.2em] text-xs">Orionites</span>, the warriors within.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#0F172A] border border-[#0F172A] rounded-[4rem] p-10 md:p-16 shadow-[0_40px_100px_-30px_rgba(15,23,42,0.3)] text-white relative overflow-hidden group">
          ...
          <div className="flex items-center gap-6 mb-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tighter font-jakarta">The Culture</h2>
          </div>
        ...
        <div className="bg-white border border-slate-100/80 rounded-[4rem] md:rounded-[5rem] p-12 md:p-24 lg:p-32 relative overflow-hidden shadow-[0_60px_120px_-40px_rgba(15,23,42,0.08)]">
          <div className="max-w-5xl space-y-12 relative z-10">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-8xl font-black text-[#0F172A] tracking-[-0.05em] leading-[0.95] font-jakarta">
              A Home Built for <span className="text-[#C8A96B] italic">Excellence.</span>
            </h2>
